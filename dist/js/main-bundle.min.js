...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Todo = function Todo(_ref) {\n  var ref_id = _ref.ref_id,\n      title = _ref.title,\n      body = _ref.body;\n\n  _classCallCheck(this, Todo);\n\n  if (title && body) {\n    this.ref_id = ref_id;\n    this.title = title;\n    this.body = body;\n    this.status = 1; //1 Open\n  } else {\n    return false;\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Todo);\n\n//# sourceURL=webpack:///./js/classes/Todo.class.js?");

/***/ }),

/***/ "./js/classes/TodoList.class.js":
/*!**************************************!*\
  !*** ./js/classes/TodoList.class.js ***!
  \**************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Todo_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Todo.class */ \"./js/classes/Todo.class.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar apiUrl = \"http://localhost:3001/api/todos\";\n\nvar TodoList =\n/*#__PURE__*/\nfunction () {\n  function TodoList() {\n    _classCallCheck(this, TodoList);\n\n    this._todos = [];\n  }\n\n  _createClass(TodoList, [{\n    key: \"updateTodoById\",\n\n    /**\n     * Function to update a todo by it's id\n     * @param {*} todoId \n     * @param {*} data \n     */\n    value: function updateTodoById(todoId, data) {\n      var _this = this;\n\n      return new Promise(function (resolve, reject) {\n        if (todoId && data) {\n          var index = _this.todos.findIndex(function (element) {\n            return element.ref_id == todoId;\n          });\n\n          if (index >= 0) {\n            var todo = _this.todos[index];\n\n            var oldTodo = _objectSpread({}, todo);\n\n            todo.title = data.title;\n            todo.body = data.body;\n            todo.status = data.status;\n            axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(\"\".concat(apiUrl, \"/\").concat(todoId), todo).then(function (r) {\n              r = r.data;\n\n              if (r.status == 1 && r.statusCode == 100) {\n                resolve(todo);\n              } else {\n                reject([Error(r.message), oldTodo]);\n              }\n            })[\"catch\"](function (error) {\n              reject([Error(error.message), oldTodo]);\n            });\n          } else {\n            reject([Error(\"Todo with given id can't be found\")]);\n          }\n        } else {\n          reject([Error(\"Required data for updating a todo is not received\")]);\n        }\n      });\n    }\n    /**\n     * Function to add a todo to the list\n     * @param {*} data \n     */\n\n  }, {\n    key: \"addTodo\",\n    value: function addTodo(data) {\n      var _this2 = this;\n\n      return new Promise(function (resolve, reject) {\n        if (data) {\n          console.log(data);\n          var todo = new _Todo_class__WEBPACK_IMPORTED_MODULE_0__[\"default\"](data);\n          console.log(todo);\n\n          if (todo) {\n            _this2.todos = todo;\n            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(apiUrl, todo).then(function (r) {\n              r = r.data;\n\n              if (r.status == 1 && r.statusCode == 100) {\n                resolve(r);\n              } else {\n                reject([Error(r.message)]);\n              }\n            })[\"catch\"](function (error) {\n              return reject([Error(error.message)]);\n            });\n          } else {\n            reject([Error(\"Todo can't be created\")]);\n          }\n        } else {\n          reject([Error(\"Required data to create Todo is not received\")]);\n        }\n      });\n    }\n    /**\n     * Function to delete a todo by given id\n     * @param {*} todoId \n     */\n\n  }, {\n    key: \"deleteTodo\",\n    value: function deleteTodo(todoId) {\n      var _this3 = this;\n\n      return new Promise(function (resolve, reject) {\n        if (todoId) {\n          var index = _this3.todos.findIndex(function (element) {\n            return element.ref_id == todoId;\n          });\n\n          if (index >= 0) {\n            _this3.todos = _this3.todos.splice(index, 1);\n            axios__WEBPACK_IMPORTED_MODULE_1___default.a[\"delete\"](\"\".concat(apiUrl, \"/\").concat(todoId)).then(function (r) {\n              r = r.data;\n\n              if (r.status == 1 && r.statusCode == 100) {\n                resolve(todoId);\n              } else {\n                reject([Error(r.message)]);\n              }\n            })[\"catch\"](function (error) {\n              return reject([Error(error.message)]);\n            });\n          } else {\n            reject([Error(\"Todo with given id cannot be found\")]);\n          }\n        }\n\n        reject([Error(\"Todo id not received\")]);\n      });\n    }\n  }, {\n    key: \"fetchTodosFromServer\",\n    value: function fetchTodosFromServer() {\n      var _this4 = this;\n\n      return new Promise(function (resolve, reject) {\n        axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(\"\".concat(apiUrl)).then(function (r) {\n          r = r.data;\n\n          if (r.status == 1 && r.statusCode == 100) {\n            _this4.todos = r.data;\n            resolve(r.data);\n          } else {\n            reject([Error(r.message)]);\n          }\n        })[\"catch\"](function (error) {\n          return reject([Error(error.message)]);\n        });\n      });\n    }\n  }, {\n    key: \"todos\",\n    get: function get() {\n      return this._todos;\n    },\n    set: function set(todo) {\n      if (Array.isArray(todo)) {\n        this._todos = todo;\n      } else {\n        this._todos.unshift(todo);\n      }\n    }\n  }]);\n\n  return TodoList;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new TodoList());\n\n//# sourceURL=webpack:///./js/classes/TodoList.class.js?");
